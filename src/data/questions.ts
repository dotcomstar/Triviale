export default [
  ...
  },
  {
    questionId: 5,
    question:
      'As a theorist, his concept of the "objective correlative" influenced New Criticism; as a playwright, his works include The Burial of the Dead and Murder in the Cathedral; but he is best known as a poet. An early precocious work includes references to Donne and Hamlet, as well as an epigraph from Dante, while later poems like "Journey of the Magi" and "Ash Wednesday" reflect a turn towards religion. His most famous reference however, was to The Canterbury Tales, in the famous opening line "April is the cruelest month". FTP name this Nobel Prize-winning poet of "The Love Song of J. Alfred Prufrock" and "The Waste-Land".',
    answer: "Eliot",
