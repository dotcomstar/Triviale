...
const questions: Question[] = [
  ...
  },
  {
    ...
    answer: "Fitzgerald",
    altAnswer: ["F Scott Fitzgerald", "Francis Scott Fitzgerald"],
  ...
  },
  {
    ...
    answer: "gravity",
    altAnswer: ["gravitation", "gravitational force"],
  ...
  },
  {
    ...
    answer: "Psycho",
    altAnswer: ["Psycho Killer", "Sweet But Psycho"],
    url: "https://files.quizbowlpackets.com/2852/Round6.pdf",
    category: ART_AND_LITERATURE,
  },
  {
  ...
  },
  {
    ...
    answer: "Mormon",
    altAnswer: ["mormonism", "Church of Jesus Christ of Latter Day Saints"],
  ...
  },
  {
    ...
    answer: "Bucks",
    altAnswer: ["Milwaukee", "Milwaukee Bucks"],
  ...
  },
  {
    ...
    answer: "King",
    altAnswer: ["Martin Luther King Jr", "MLK", "MLK JR"],
    fullAnswer: "Martin Luther King Jr",
    url: "https://files.quizbowlpackets.com/2702/Round1.pdf",
    category: HISTORY,
  },
  {
  ...
  },
  {
    ...
    answer: "Nolan",
    altAnswer: ["christopher nolan"],
    fullAnswer: "Christopher Nolan",
    category: POP_CULTURE,
  },
  {
  ...
  },
  {
    ...
    answer: "Curie",
    altAnswer: ["Marie Curie"],
    fullAnswer: "Marie Curie",
    category: SCIENCE,
  },
  {
    ...
    answer: "Colossus",
    altAnswer: ["The Colossus at Rhodes"],
    fullAnswer: "The Colossus at Rhodes",
    category: HISTORY,
  },
  {
  ...
  {
    question: `This man disclosed loans from his parents in a speech that became nicknamed for a cocker spaniel. In 1973, this man spoke at Disney World, declaring “I’m not a crook;” a year later, after a “smoking gun” tape was released, he wrote a letter to Henry Kissinger resigning his office. Gerald Ford succeeded and pardoned, for the point, what US President who was embroiled in the Watergate scandal?`,
    answer: "Nixon",
  ...
  {
    question: `This orchestral instrument plays the opening “Promenade” theme of Mussorgsky’s Pictures at an Exhibition, and several of them play the rising notes C-G-C to open Strauss’s Also Sprach Zarathustra. This valved instrument is commonly used to play “Taps.” The cornet and bugle are relatives of, for the point, what highest-pitched brass instrument?`,
    answer: "trumpet",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round2.pdf",
    category: ART_AND_LITERATURE,
  },
  {
    question: `The Power of a Point theorem concerns the distance of a point from one of these figures. The equation x squared plus y squared equals r squared, where r is a real number, will graph one of these shapes, which are defined as all points that are the same distance from one point. For the point, name this shape whose area formula is pi times the square of its radius.`,
    answer: "circle",
    altAnswer: ["circles"],
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round2.pdf",
    category: SCIENCE,
  ...
  },
  {
    ...
    answer: "Columbus",
    altAnswer: ["Christopher Columbus"],
  ...
  {
    question: `Settlers in this state were led by William B. Ide during a revolt commemorated by its state flag, which features a grizzly bear. In the 1840s, John Fremont explored much of this state, including the San Joaquin Valley. For the point, name this western US state whose population boomed from “Forty-Niners” seeking gold near Sacramento.`,
    answer: "California",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round8.pdf",
    category: HISTORY,
  },
  {
    question: `In a novel titled for this medical condition, the doctor’s wife is the only character not affected by this condition, which is compared to “falling into a milky sea.” The sonnet “When I Consider How My Light is Spent” describes a poet with this medical condition, which may have been caused by a detached retina. For the point, John Milton was affected by what condition that titles a Jose Saramago novel about people losing their ´ eyesight?`,
    answer: "blindness",
    altAnswer: ["blind"],
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round8.pdf",
    category: ART_AND_LITERATURE,
  ...
  {
    question: `Litharge, an oxide of this element, is a component of fine crystal. This final element in the uranium decay chain was once used as an antiknock agent added to gasoline. Patients undergoing an x-ray wear an apron with this element as shielding. This element’s high toxicity prevents its modern use in paint and water pipes. For the point, name this metallic element used in bullets, but not pencils, whose symbol is Pb.`,
    answer: "Lead",
    altAnswer: ["pb"],
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round8.pdf",
    category: SCIENCE,
  ...
  {
    question: `In 1846, this country’s city of Angostura changed its name to Ciudad Bolivar. The ABC islands of Aruba, Bonaire, and Curacao are just north of this mainland country, a little east of the opening to Lake Maracaibo. The Orinoco River flows through this country into the Atlantic Ocean just northwest of Guyana. For the point, name this South American country, found east of Colombia, whose capital city is Caracas.`,
    answer: "Venezuela",
  ...
  {
    question: `The family of Dick Grayson, the original Robin, worked in this type of place. The song “Entry of the Gladiators” is commonly played at this type of place, one of which was operated until 2017 by Ringling Brothers and Barnum and Bailey. For the point, name this type of traveling performance that commonly involves lion tamers, ring masters, and clowns.`,
    answer: "circus",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round7.pdf",
    category: POP_CULTURE,
  },
  {
    question: `The man who discovered this object’s orbit died in 1742, sixteen years before he could prove that it is periodic. The European Space Agency’s Giotto was one of five spacecraft that studied this object in 1986, the last time it was visible to the naked eye. For the point, name this object that approaches Earth every seventy-six years and is probably the most famous comet.`,
    answer: "Halleys Comet",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round7.pdf",
    category: SCIENCE,
  },
  {
    question: `The Rothschild subspecies of these animals have five ossicones, although most of these animals only have two, as do these animals’ relatives, okapis. Darwin described these animals as “beautifully adapted for browsing on the higher branches of trees.” For the point, name these mammals whose long necks make them the tallest land animals in the world.`,
    answer: "giraffes",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round7.pdf",
    category: SCIENCE,
  },
  {
    question: `This poem’s speaker asks if in “the distant Aidenn” he could “clasp a sainted maiden” after he responds to a strange tapping at his window. An animal in this poem perches on a “pallid bust of Pallas” and seems to taunt the speaker over the death of Lenore by repeating the word “nevermore.” For the point, name this poem about a man driven to despair by a black bird, written by Edgar Allan Poe.`,
    answer: "The Raven",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round7.pdf",
    category: ART_AND_LITERATURE,
  },
  {
    question: `Decreases in this phenomenon and the LFPR indicates a rise in discouragement. This economic phenomenon can be structural, when it is caused by technological changes, or frictional, which reflects the time spent trying to end this phenomenon. Retired people are not counted by, for the point, what negative economic rate that describes the number of people who aren’t working?`,
    answer: "unemployment rate",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round7.pdf",
    category: POP_CULTURE,
  },
  {
    question: `This quantity can be defined as momentum squared divided by two times the mass. This quantity is conserved during elastic collisions but not inelastic collisions, and it is calculated by the formula one-half times mass times velocity squared. A roller coaster maximizes this energy at the bottom of a hill. For the point, name this type of energy that is possessed by all moving objects, often contrasted with potential energy`,
  ...
  {
    question: `This goddess’s tears turn into red gold when she misses her husband Odr. Half of those killed in battle go to this goddess’s hall, Folkvangr. Loki turned into a fly in an attempt to steal Brisingamen, this goddess’s necklace, and she rides a chariot pulled by cats. Thor dressed like this goddess in order to retrieve his stolen hammer.  For the point, name this Norse goddess of love and beauty.`,
    answer: "Freyja",
    url: "https://files.quizbowlpackets.com/2364/SCOP10%20MS%20Round8.pdf",
    category: RELIGION,
  },
  {
    question: `A poem by this writer promises “I will come again, my love / though ‘twere ten thousand mile” and compares love to a “red, red rose.” This poet says “we’ll tak’ a cup o’ kindness yet” and asks “should auld acquaintance be forgot” in his local dialect, which he also used for a poem in which “the best laid schemes o’ Mice an’ Men / gang aft agley.” For the point, name this Scottish poet of “Auld Lang Syne” and “To a Mouse” whose name describes what you would get if you touched a fire.`,
    answer: "Burns",
  ...
  {
    question: `This ruler legendarily dissolved the world’s largest pearl in vinegar, then drank it to win a bet. A carpet was used to sneak this ruler into the headquarters of Julius Caesar. After losing the Battle of Actium, this ruler supposedly asked for and received a basket of figs, which hid an asp that she then used to commit suicide. For the point, name this Egyptian pharaoh, the lover of Julius Caesar and Marc Antony`,
    answer: "Cleopatra",
  ...
  {
    question: `In a song by this band, Halsey sings “I want something stronger / Than a moment, than a moment, luv” and repeats the phrase “oh, my, my, my.” The albums Wings and 2 Cool 4 Skool are by this group, which became the first K-Pop group to win a Billboard Music Award. “Blood, Sweat, and Tears” and “Boy With Luv” are by, for the point, what seven-member Korean boy band?`,
    answer: "BTS",
    altAnswer: [
      "Bangtan Sonyeondan",
      "Bangtan Boys",
